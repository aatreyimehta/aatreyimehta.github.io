...
def write_circle_target_data1_elongated(data, filepath, figsize=(1024, 512), draw_grid=False, tick_step=10):
    ...
    fig.update_layout(
        ...
        width=figsize[0], height=figsize[1],
        yaxis_range=[3.5,110],
        #yaxis_range=[0.029,110],
        xaxis_range=[-0.5,10],
        #xaxis={"showticklabels": False, "linewidth": 2, "linecolor": 'black', "position": 0.029},
        xaxis={"showticklabels": False, "linewidth": 2, "linecolor": 'black'},
        yaxis={"showticklabels": False, "linewidth": 2, "linecolor": 'black', "ticks": "outside", "dtick": tick_step, "ticklen": 0, "tickwidth": 0, "ticklen": 10, "tickwidth": 2, "showgrid":False},
        showlegend=False
    )    
...
def write_source_data_2(data, filepath, figsize=(600, 512), draw_grid=False, tick_step=10):
...
def write_circle_target_data_2(data, filepath, figsize=(600, 512), draw_grid=False, tick_step=10):
    fig = go.Figure()
    for i in range(len(data)):
        for j in range(len(data[i])):
            fig.add_trace(go.Scatter(x=data[i][j]["x"],
...
def write_circle_target_data1_2(data, filepath, figsize=(600, 512), draw_grid=False, tick_step=10):
    fig = go.Figure()
    for i in range(len(data)):
        for j in range(len(data[i])):
            fig.add_trace(go.Scatter(x=data[i][j]["x"],
...
def write_source_data_3(data, filepath, figsize=(512, 662), draw_grid=False, tick_step=10):
...
def write_circle_target_data_3(data, filepath, figsize=(512, 662), draw_grid=False, tick_step=10):
    fig = go.Figure()
    for i in range(len(data)):
        for j in range(len(data[i])):
            fig.add_trace(go.Scatter(x=data[i][j]["x"],
...
def write_circle_target_data1_3(data, filepath, figsize=(512, 662), draw_grid=False, tick_step=10):
    fig = go.Figure()
    for i in range(len(data)):
        for j in range(len(data[i])):
            fig.add_trace(go.Scatter(x=data[i][j]["x"],
