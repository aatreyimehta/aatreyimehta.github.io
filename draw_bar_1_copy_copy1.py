...
from bar_generator_1_copy_copy1 import generate_data, write_source_data_1, write_circle_target_data_1, write_circle_target_data1_1, serialize_data
#from bar_generator_1_copy_copy1 import generate_data, write_source_data_1, write_circle_target_data_1, write_circle_target_data1_1, write_source_data, write_circle_target_data, write_circle_target_data1, write_source_data_2, write_circle_target_data_2, write_circle_target_data1_2, write_source_data_3, write_circle_target_data_3, write_circle_target_data1_3, write_source_data_elongated, write_circle_target_data_elongated, write_circle_target_data1_elongated, serialize_data
...
"""           
        ...
        write_source_data_2(data[i], f"./data/source/s_{i+4001}.png", fig_size2, draw_grid, tick_step)
        postprocessing(f"./data/source/s_{i+4001}.png")
        
        write_circle_target_data_2(circle_data[i], f"./data/tactile/t_{i+4001}.png", fig_size2, draw_grid, tick_step)
        maskgen(f"./data/tactile/t_{i+4001}.png")
        
        write_circle_target_data1_2(circle_data[i], f"./data/tactile1/t_{i+4001}.png", fig_size2, draw_grid, tick_step)
        print(f"./data/tactile1/t_{i+4001}.png")
        
        
        write_source_data_3(data[i], f"./data/source/s_{i+2001}.png", fig_size3, draw_grid, tick_step)
        postprocessing(f"./data/source/s_{i+2001}.png")
        
        write_circle_target_data_3(circle_data[i], f"./data/tactile/t_{i+2001}.png", fig_size3, draw_grid, tick_step)
        maskgen(f"./data/tactile/t_{i+2001}.png")
        
        write_circle_target_data1_3(circle_data[i], f"./data/tactile1/t_{i+2001}.png", fig_size3, draw_grid, tick_step)
