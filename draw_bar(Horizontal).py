...
with tf.device('/device:GPU:0'):
    ...
    for i in tqdm(range(len(data)), desc='bar charts: '):
        ...
        fig_size_1 = random.choices([[700,512], [700,512], [700,512]], weights=[.25, .5, .5])[0]
        fig_size_2 = random.choices([[512,672], [512,672], [512,672]], weights=[.5, .25, .25])[0]
        #fig_size = random.choices([[512,512], [512,512], [512,512]], weights=[.5, .5, .5])[0]
        fig_size_3 = random.choices([[672,512], [672,512], [672,512]], weights=[.5, .25, .25])[0]
