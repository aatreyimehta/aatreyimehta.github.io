...
def write_source_data(data, filepath, figsize=(600, 512), draw_grid=False, tick_step=10, grid_probability=global_grid_probability):
    ...
    with open("x_1.txt","r") as f:
    	x_options = f.readline().split()
    
    with open("y_1.txt","r") as f:
    ...
    fig.update_layout(
    	...
    	title_font_size=random.randint(35,39),
...
"""
"""  
def write_circle_target_data(data, filepath, figsize=(512, 672), draw_grid=False, tick_step=10):
    fig = go.Figure()
