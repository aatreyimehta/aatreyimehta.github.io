...
def write_circle_target_data(data, filepath, figsize=(512, 512), draw_grid=False, tick_step=10):
    ...
    fig.update_layout(
        ...
        #xaxis={"showticklabels": False, "linewidth": 2, "linecolor": 'black', "ticks": "outside", "dtick": 110 / (num_ticks), "ticklen": 10, "tickwidth": 2},
...
def write_source_data_1(data, filepath, figsize=(700,512), draw_grid=False, tick_step=10):
...
def write_circle_target_data_1(data, filepath, figsize=(700,512), draw_grid=False, tick_step=10):
    fig = go.Figure()
    for i in range(len(data)):
        for j in range(len(data[i])):                              
            n = 1
...
def write_circle_target_data1_1(data, filepath, figsize=(700,512), draw_grid=False, tick_step=10):
    fig = go.Figure()
    for i in range(len(data)):
        for j in range(len(data[i])):
            n = 1
...
# Draw source domain
def write_source_data_2(data, filepath, figsize=(512, 672), draw_grid=False, tick_step=10):
...
def write_circle_target_data_2(data, filepath, figsize=(512, 672), draw_grid=False, tick_step=10):
    fig = go.Figure()
    for i in range(len(data)):
        for j in range(len(data[i])):
            fig.add_trace(go.Scatter(x=data[i][j]["y"],
...
def write_circle_target_data1_2(data, filepath, figsize=(512, 672), draw_grid=False, tick_step=10):
    fig = go.Figure()
    for i in range(len(data)):
        for j in range(len(data[i])):
            fig.add_trace(go.Scatter(x=data[i][j]["y"],
...
# Draw source domain
def write_source_data_3(data, filepath, figsize=(672, 512), draw_grid=False, tick_step=10):
...
def write_circle_target_data_3(data, filepath, figsize=(672, 512), draw_grid=False, tick_step=10):
    fig = go.Figure()
    for i in range(len(data)):
        for j in range(len(data[i])):
            fig.add_trace(go.Scatter(x=data[i][j]["y"],
...
def write_circle_target_data1_3(data, filepath, figsize=(672, 512), draw_grid=False, tick_step=10):
    fig = go.Figure()
    for i in range(len(data)):
        for j in range(len(data[i])):
            fig.add_trace(go.Scatter(x=data[i][j]["y"],
